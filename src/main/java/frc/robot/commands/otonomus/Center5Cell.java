...
public class Center5Cell extends SequentialCommandGroup {
  /**
   * Creates a new Center5Cell.
   */
  public Center5Cell(SneakyTrajectory s_trajectory, Shooter shooter, intake Intake
  , HopperSubsystem hopper, DriveSubsystem drive) {
    ...
    s_trajectory.getRamsete(s_trajectory.center5cell[0]).raceWith(new HopperCommands(hopper, 0.5))
    .raceWith(new RunIntake(Intake, 0.75)).andThen(() -> drive.arcadeDrive(0, 0)),
    s_trajectory.getRamsete(s_trajectory.center5cell[1]).andThen(() -> drive.arcadeDrive(0, 0)),

...
public class Center5Cell extends SequentialCommandGroup {
  ...
  , HopperSubsystem hopper, DriveSubsystem drive) {
    ...
    s_trajectory.getRamsete(s_trajectory.center5cell_0).raceWith(new HopperCommands(hopper, 0.5))
    .raceWith(new RunIntake(Intake, 0.75)).andThen(() -> drive.arcadeDrive(0, 0)),
    s_trajectory.getRamsete(s_trajectory.center5cell_1).andThen(() -> drive.arcadeDrive(0, 0)),

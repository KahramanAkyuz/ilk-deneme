...
public class Right7Cell extends SequentialCommandGroup {
  /**
   * Creates a new Right7Cell.
   */
  public Right7Cell(SneakyTrajectory s_trajectory, Shooter shooter, intake Intake
  , HopperSubsystem hopper, DriveSubsystem drive) {
    ...
    s_trajectory.getRamsete(s_trajectory.right7cell_0).raceWith(new HopperCommands(hopper, 0.5))
    .raceWith(new RunIntake(Intake, 0.75)).andThen(() -> drive.arcadeDrive(0, 0)),
    s_trajectory.getRamsete(s_trajectory.right7cell_1).andThen(() -> drive.arcadeDrive(0, 0)),

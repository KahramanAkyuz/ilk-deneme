...
public class Right7Cell extends SequentialCommandGroup {
  ...
  , HopperSubsystem hopper, DriveSubsystem drive) {
    ...
    s_trajectory.getRamsete(s_trajectory.right7cell[0]).raceWith(new HopperCommands(hopper, 0.5))
    .raceWith(new RunIntake(Intake, 0.75)).andThen(() -> drive.arcadeDrive(0, 0)),
    s_trajectory.getRamsete(s_trajectory.right7cell[1]).andThen(() -> drive.arcadeDrive(0, 0)),
